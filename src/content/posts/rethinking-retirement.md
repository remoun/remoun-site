...
Bill Perkins' book _Die With Zero_ reframes the question entirely. Instead of "how do I never run out?", it asks "how do I extract maximum life from my resources?"
...
I turned the model into an [interactive calculator](/fire-calculator) that anyone can use. It compares traditional FIRE (4% rule, preserve principal forever) against a Die With Zero approach (spend and give deliberately, target near-zero at end of life).

The side-by-side visualization makes the tradeoff visceral. With the same starting point, you can see:

- How much _more_ you could spend each year
...
_The [FIRE Lifestyle Calculator](/fire-calculator) is free to use. If you build on it or find it useful, I'd love to hear about it._
