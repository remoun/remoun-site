...
I have a YunoHost VPS. Registering a runner there was straightforward. Making `sudo yunohost ...` work non-interactively from the runner, which ate an afternoon.
